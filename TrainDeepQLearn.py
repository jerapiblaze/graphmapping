...
def Main():
    ...
    agent = DQL.agent.DeepQlearnAgent(env.action_space.n, len(obs), gamma=0.8, eps_decay=1000, eps_start=0.9, eps_end=0.05, replay_buffer=10000, batch_size=128, tau=0.005, lr=1e-4)
